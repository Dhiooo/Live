...
class HistoryBook extends Tugas4.Book {
...
abstract class User {
    ...
    public abstract void displayBooks(Tugas4.Book[] bookList);

    public abstract void displayBooks(ArrayList<Tugas4.Book> bookList);
}